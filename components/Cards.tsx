    ...
    >
      ...
      <View className="flex flex-col items-start absolute bottom-5 inset-x-5">
        ...
        <View className="flex flex-row items-center justify-between w-full">
          <Text className="text-xl font-rubikExtraBold text-white">${item?.price}</Text>
...
export const Card = ({ onPress, item }: Props) => {
  return (
    <TouchableOpacity
      onPress={onPress}
      className="flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white text-black-300 shadow-lg shadow-black-100/70 relative"
    >
